...
const handleFinish = async () => {
  try {
    // 1️⃣ Create company first (without adminId yet)
    const companyData = {
    ...
    // 2️⃣ Create admin linked to company
    const adminData = {
    ...
    // 3️⃣ Update company to store adminId
    await setDoc(doc(db, "companies", companyRef.id), {
      ...companyData,
      adminId: adminRef.id
    });
